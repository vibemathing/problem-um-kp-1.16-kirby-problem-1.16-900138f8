...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-1.16-kirby-problem-1.16-900138f8-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-1.16"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-1.16-kirby-problem-1.16-900138f8-v1",
      "problem_contract_sha256": "62e68d91227a523d235737eca17ce5382fd80f9e54a02f4a745e5cf86ec07384",
      "problem_id": "problem:um-kp-1.16-kirby-problem-1.16-900138f8",
      "route_id": "route:um-kp-1.16-kirby-problem-1.16-900138f8-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-1.16-kirby-problem-1.16-900138f8-source-fidelity-01",
      "graph_id": "graph:um-kp-1.16-kirby-problem-1.16-900138f8-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-1.16-kirby-problem-1.16-900138f8-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-1.16-kirby-problem-1.16-900138f8-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(a) Given a knot $K \\subset S^{3}$ determine all knots $K' \\subset S^{3}$ for which the branched double covers of $S^{3}$ along $K$ and $K'$ are homeomorphic. (b) Find a set of moves on links in $S^{3}$ so that two links are related by these moves if and only if they have the same branched double cover."
          },
          "statement_sha256": "4bcc6c5af86e2c3790229ce8d5e9cddb50ce01dfbf67cdb030a790febadde7f0"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-1.16-kirby-problem-1.16-900138f8-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-1.16-kirby-problem-1.16-900138f8-root",
      "route_id": "route:um-kp-1.16-kirby-problem-1.16-900138f8-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-1.16-e8e23793b9e4",
        "url": "https://www.unsolvedmath.com/problems/KP-1.16"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
